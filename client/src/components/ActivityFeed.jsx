...
export function ActivityFeedComponent(_a) {
    ...
    return (<div className="space-y-4">
            {activities.length === 0 && (<div className="text-center py-12 bg-white/30 dark:bg-slate-900/30 rounded-3xl border border-dashed">
                    <p className="text-muted-foreground">No recent activity. Be the first to share!</p>
                </div>)}
            {__spreadArray([], activities, true).reverse().map(function (item) { return (<Card key={item.id} className="p-4 border-none shadow-sm bg-white/50 dark:bg-slate-900/50 hover:bg-white/80 transition-colors">
