...
export function ComingSoon() {
    return (<div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {upcomingFeatures.map(function (feature, index) { return (<div key={index} className="relative overflow-hidden bg-white dark:bg-slate-800 rounded-2xl p-4 border border-slate-200 dark:border-slate-700 opacity-75 hover:opacity-100 transition-all">
            {/* Coming Soon Badge */}
            ...
            <div className="flex items-start gap-3">
              <div className={"p-2 rounded-xl ".concat(feature.color)}>
