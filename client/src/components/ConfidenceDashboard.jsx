...
export function ConfidenceDashboard(_a) {
    var confidenceScore = _a.confidenceScore, topicsCompleted = _a.topicsCompleted, totalTopics = _a.totalTopics, interviewAnswers = _a.interviewAnswers, speakingMinutes = _a.speakingMinutes, strengths = _a.strengths, focusAreas = _a.focusAreas;
    ...
    var getScoreEmoji = function (score) {
        if (score >= 80)
            return "🌟";
        if (score >= 60)
            return "💪";
    ...
    return (<div className="bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 p-6 shadow-lg">
      ...
      <div className="text-center mb-8">
        <div className="relative inline-flex items-center justify-center">
          <svg className="w-32 h-32 transform -rotate-90">
            ...
            <circle cx="64" cy="64" r="56" stroke="currentColor" strokeWidth="12" fill="none" strokeDasharray={"".concat(confidenceScore * 3.52, " 352")} strokeLinecap="round" className={getScoreColor(confidenceScore)}/>
          </svg>
      ...
      <div className="mb-4">
        ...
        <div className="space-y-2">
          {strengths.map(function (strength, i) { return (<div key={i} className="flex items-center gap-2 text-sm text-green-700 dark:text-green-400">
      ...
      <div>
        ...
        <div className="space-y-2">
          {focusAreas.map(function (area, i) { return (<div key={i} className="flex items-center gap-2 text-sm text-amber-700 dark:text-amber-400">
