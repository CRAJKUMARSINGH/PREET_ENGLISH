...
export function ConversationPractice() {
    var _a = useState(conversations[0]), selectedConversation = _a[0], setSelectedConversation = _a[1];
    var _b = useState(0), currentLine = _b[0], setCurrentLine = _b[1];
    return (<div className="space-y-6">
            {/* Conversation Cards */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {conversations.map(function (conv) { return (<Card key={conv.id} className={"cursor-pointer transition-all hover:shadow-lg ".concat(selectedConversation.id === conv.id ? "border-primary ring-2 ring-primary/20" : "")} onClick={function () {
            ...
            <Card className="border-2 border-green-200 dark:border-green-800">
                <CardContent className="p-6 space-y-4">
                    ...
                    <div className="space-y-4">
                        {selectedConversation.dialogue.map(function (line, index) { return (<div key={index} className={"p-4 rounded-lg transition-all ".concat(index === currentLine
                ...
                : "bg-gray-50 dark:bg-gray-800")}>
                    ...
                    <div className="flex justify-between pt-4">
                        <Button variant="outline" disabled={currentLine === 0} onClick={function () { return setCurrentLine(function (prev) { return prev - 1; }); }}>
                            Previous
                        </Button>
                        <Button disabled={currentLine === selectedConversation.dialogue.length - 1} onClick={function () { return setCurrentLine(function (prev) { return prev + 1; }); }}>
                            Next
                        </Button>
                    </div>
                </CardContent>
