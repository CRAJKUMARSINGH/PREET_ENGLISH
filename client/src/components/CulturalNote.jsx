...
export function CulturalNote(_a) {
    var title = _a.title, hindiTitle = _a.hindiTitle, content = _a.content, hindiContent = _a.hindiContent, _b = _a.type, type = _b === void 0 ? "context" : _b, className = _a.className;
    ...
    return (<Card className={cn("overflow-hidden border-none bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-950 shadow-xl ring-1 ring-slate-200 dark:ring-slate-800", className)}>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 space-y-4">
                        <div>
                            ...
                            {hindiTitle && (<p className="text-sm font-hindi text-slate-500 dark:text-slate-400 mt-0.5">
                                    {hindiTitle}
                                </p>)}
                        </div>
                        ...
                        <div className="relative">
                            ...
                            {hindiContent && (<div className="mt-4 p-4 rounded-xl bg-amber-500/5 border border-amber-500/10 relative group">
