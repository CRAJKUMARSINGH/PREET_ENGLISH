...
export function DailyGoalCard({
  ...
  return (
    <div className="glass-card rounded-[2rem] p-8 h-full border-border/50 relative overflow-hidden group">
      {/* Ambient Glow */}
      ...
      <div className="flex items-center justify-between mb-8 relative z-10">
        ...
        {allComplete && (
          <div className="bg-primary text-primary-foreground px-4 py-1.5 rounded-full text-sm font-bold flex items-center gap-2 shadow-lg shadow-primary/20 animate-bounce-in">
      ...
      <div className="space-y-6 relative z-10">
        ...
        <div className="group/item">
          ...
          <div className="h-3 bg-secondary rounded-full overflow-hidden border border-border/50 shadow-inner">
            <div
              className={cn("h-full rounded-full transition-all duration-700 shadow-[0_0_10px_rgba(59,130,246,0.2)]", lessonsProgress >= 100 ? "bg-green-500" : "bg-blue-500")}
        ...
        <div className="group/item">
          ...
          <div className="h-3 bg-secondary rounded-full overflow-hidden border border-border/50 shadow-inner">
            <div
              className={cn("h-full rounded-full transition-all duration-700 shadow-[0_0_10px_rgba(234,179,8,0.2)]", xpProgress >= 100 ? "bg-green-500" : "bg-yellow-500")}
        ...
        <div className="group/item">
          ...
          <div className="h-3 bg-secondary rounded-full overflow-hidden border border-border/50 shadow-inner">
            <div
              className={cn("h-full rounded-full transition-all duration-700 shadow-[0_0_10px_rgba(168,85,247,0.2)]", minutesProgress >= 100 ? "bg-green-500" : "bg-purple-500")}
