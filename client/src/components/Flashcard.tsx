...
import { Volume2, RotateCcw, Check, Sparkles, Brain } from "lucide-react";
...
export function Flashcard({ word, onRate }: FlashcardProps) {
    ...
    return (
        <div className="w-full max-w-md mx-auto h-[400px] perspective-1000">
            <motion.div
                className="relative w-full h-full text-center transition-all duration-500 preserve-3d cursor-pointer"
                initial={false}
            ...
            >
                ...
                {/* Back Side */}
                <Card
                    className="absolute inset-0 backface-hidden flex flex-col items-center justify-center p-8 border-2 border-amber-500/20 shadow-xl overflow-hidden bg-gradient-to-br from-amber-50 to-orange-50 rotate-y-180"
                >
            ...
            <AnimatePresence>
                {isFlipped && (
                    ...
                    >
                        <Button
                            variant="outline"
                            className="flex-1 bg-red-50 hover:bg-red-100 border-red-200 text-red-700 h-12 flex flex-col"
                        ...
                        <Button
                            variant="outline"
                            className="flex-1 bg-orange-50 hover:bg-orange-100 border-orange-200 text-orange-700 h-12 flex flex-col"
                        ...
                        <Button
                            variant="outline"
                            className="flex-1 bg-blue-50 hover:bg-blue-100 border-blue-200 text-blue-700 h-12 flex flex-col"
                        ...
                        <Button
                            variant="outline"
                            className="flex-1 bg-green-50 hover:bg-green-100 border-green-200 text-green-700 h-12 flex flex-col"
