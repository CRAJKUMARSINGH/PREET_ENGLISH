...
export function ProgressDashboard() {
  const overallProgress = Math.round(skillsProgress.reduce((acc, s) => acc + s.progress, 0) / skillsProgress.length);
  const earnedAchievements = recentAchievements.filter(a => a.earned).length;
