...
export function FlashcardSystem() {
  ...
  const markAsKnown = () => {
    ...
    const newReviewCards = new Set(Array.from(reviewCards));
  ...
  const markForReview = () => {
    setReviewCards(prev => new Set([...Array.from(prev), currentCard.id]));
    const newKnownCards = new Set(Array.from(knownCards));
  ...
  return (
    <div className="flashcard-system space-y-6">
      {/* Header */}
      <Card>
        <CardHeader>
      ...
      >
        <Card className={cn(
          ...
          isFlipped ? "bg-blue-50 dark:bg-blue-950/20" : "bg-white dark:bg-gray-900"
        )}>
          <CardContent className="p-8 flex flex-col items-center justify-center min-h-[300px]">
            {!isFlipped ? (
              ...
              <div className="text-center">
                ...
                <Button variant="outline" size="sm" onClick={(e) => { e.stopPropagation(); playAudio(); }}>
