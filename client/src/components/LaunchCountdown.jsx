...
export function LaunchCountdown() {
    var launchDate = new Date('2025-01-15T00:00:00'); // Set your launch date
    var _a = useState(calculateTimeLeft()), timeLeft = _a[0], setTimeLeft = _a[1];
    var _b = useState(false), isLaunched = _b[0], setIsLaunched = _b[1];
    function calculateTimeLeft() {
        var difference = +launchDate - +new Date();
        if (difference > 0) {
            return {
    ...
    useEffect(function () {
        var timer = setInterval(function () {
            var newTimeLeft = calculateTimeLeft();
    ...
    if (isLaunched) {
        return (<Card className="bg-gradient-to-br from-green-500 to-emerald-600 text-white">
    ...
    return (<Card className="bg-gradient-to-br from-purple-500 to-pink-600 text-white">
      <CardHeader>
