...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  // Complete Navigation Groups - Hindi-Focused Learning Platform
  const navGroups = [
    {
      title: "Learn",
      items: [
        { href: "/", label: t("home"), icon: Home },
        { href: "/hindi-learning", label: "🇮🇳 Hindi Path", icon: BookOpen },
    ...
    },
    {
      title: "Practice",
      items: [
        { href: "/review", label: "Daily Review", icon: Calendar },
