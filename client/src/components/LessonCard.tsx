...
import { Clock, ArrowRight, CheckCircle2, BarChart, Volume2 } from "lucide-react";
            ...
            <div className="flex items-start justify-between gap-2">
              ...
              <button
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  speak({ text: lesson.hindiTitle!, lang: 'hi-IN' });
                }}
                className="p-1.5 rounded-full hover:bg-primary/10 text-primary/70 hover:text-primary transition-colors shrink-0"
                title="Listen"
              >
