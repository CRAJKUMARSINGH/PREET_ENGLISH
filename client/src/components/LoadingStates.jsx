...
export function LoadingPage() {
    return (<div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 to-accent/5">
...
export function LoadingCard() {
    return (<div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 animate-pulse">
...
export function LoadingSkeleton(_a) {
    var _b = _a.count, count = _b === void 0 ? 3 : _b;
    return (<div className="space-y-4">
      {Array.from({ length: count }).map(function (_, i) { return (<LoadingCard key={i}/>); })}
    </div>);
}
