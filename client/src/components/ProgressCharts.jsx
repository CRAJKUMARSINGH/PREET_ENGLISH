...
var COLORS = ['#8b5cf6', '#ea580c', '#10b981', '#3b82f6', '#f59e0b'];
...
export function ProgressCharts(_a) {
    var _b = _a.activityData, activityData = _b === void 0 ? defaultActivityData : _b, _c = _a.categoryData, categoryData = _c === void 0 ? defaultCategoryData : _c;
    return (<div className="grid md:grid-cols-2 gap-6 w-full">
            {/* Activity Chart */}
            ...
            boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)'
                                ...
                                <Line type="monotone" dataKey="xp" stroke="#8b5cf6" strokeWidth={3} dot={{ fill: '#8b5cf6', strokeWidth: 2 }} activeDot={{ r: 6 }}/>
                            </LineChart>
                        </ResponsiveContainer>
                    </CardContent>
                </Card>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                                <Pie data={categoryData} cx="50%" cy="50%" innerRadius={60} outerRadius={100} paddingAngle={5} dataKey="value">
                                    {categoryData.map(function (entry, index) { return (<Cell key={"cell-".concat(index)} fill={entry.color || COLORS[index % COLORS.length]}/>); })}
                                </Pie>
                                <Tooltip contentStyle={{
            backgroundColor: 'rgba(255, 255, 255, 0.95)',
            borderRadius: '12px',
