import { Play, Headphones, BookOpen, Globe, ArrowRight } from "lucide-react";
    ...
    return (<section>
      ...
      <div className="space-y-4">
        {resources.map(function (resource, index) {
            var config = typeConfig[resource.type];
            return (<a key={index} href={resource.url} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 bg-white/50 dark:bg-white/5 rounded-2xl border border-border/50 p-4 hover:bg-white dark:hover:bg-white/10 hover:shadow-lg hover:border-primary/20 transition-all duration-300">
