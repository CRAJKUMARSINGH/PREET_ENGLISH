...
export function SaraswatiLogo({ size = "md" }: { size?: "xs" | "sm" | "md" | "lg" }) {
  const sizeClasses = {
    xs: "w-8 h-8",
    sm: "w-10 h-10",
    md: "w-12 h-12",
  ...
  return (
    <div className={cn("flex flex-col items-center", className)}>
      ...
      <div className={cn(
        ...
        "border-[3px] border-primary/20 p-1",
        "bg-background",
        sizeClasses[size]
      )}>
      ...
      {/* Credit Badge */}
      {showCredit && (
        <div className="mt-3 bg-primary/5 border border-primary/20 rounded-full px-4 py-1.5 backdrop-blur-sm">
      ...
      {showMessage && (
        <div className="relative mt-4 max-w-[240px] animate-fade-in-up">
