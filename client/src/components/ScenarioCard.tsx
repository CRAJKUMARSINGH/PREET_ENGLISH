import { MessageCircle, Play, CheckCircle, Star } from "lucide-react";
...
export function ScenarioCard({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "bg-white rounded-2xl p-5 border shadow-sm cursor-pointer transition-all duration-300",
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {titleHindi && (
            <p className="text-sm text-slate-600 mb-2">{titleHindi}</p>
          )}
