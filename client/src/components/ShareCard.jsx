...
export var ShareCard = forwardRef(function (_a, ref) {
    var username = _a.username, achievement = _a.achievement, type = _a.type, value = _a.value;
    return (<div ref={ref} className="w-[400px] h-[600px] bg-gradient-to-br from-[#064e3b] to-[#047857] p-8 text-white relative overflow-hidden flex flex-col items-center justify-between shadow-2xl">
            {/* Background patterns */}
