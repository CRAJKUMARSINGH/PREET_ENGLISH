...
export function SocialShare(_a) {
    var _this = this;
    ...
    var handleTwitterShare = function () {
        var twitterUrl = "https://twitter.com/intent/tweet?text=".concat(encodeURIComponent(text), "&url=").concat(encodeURIComponent(shareUrl));
        window.open(twitterUrl, '_blank', 'width=550,height=420');
    };
    var handleLinkedInShare = function () {
        var linkedinUrl = "https://www.linkedin.com/sharing/share-offsite/?url=".concat(encodeURIComponent(shareUrl));
        window.open(linkedinUrl, '_blank', 'width=550,height=420');
    };
    var handleFacebookShare = function () {
        var facebookUrl = "https://www.facebook.com/sharer/sharer.php?u=".concat(encodeURIComponent(shareUrl));
    ...
    return (<DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-48">
        {'share' in navigator && (<DropdownMenuItem onClick={handleNativeShare}>
            <Share2 className="h-4 w-4 mr-2"/>
            Share...
          </DropdownMenuItem>)}
