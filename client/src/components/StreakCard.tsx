...
export function StreakCard({ currentStreak, longestStreak, xpPoints, level }: StreakCardProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-orange-500 via-pink-500 to-purple-600 p-8 text-white shadow-xl group hover:shadow-2xl transition-all duration-500">
      {/* Background Pattern */}
      ...
      <div className="relative z-10">
        ...
        <div className="mt-6">
          ...
          <div className="h-3 bg-black/20 rounded-full overflow-hidden backdrop-blur-sm border border-white/10">
            <div
              className="h-full bg-gradient-to-r from-yellow-300 to-yellow-500 rounded-full transition-all duration-1000 shadow-[0_0_10px_rgba(253,224,71,0.5)] relative overflow-hidden"
