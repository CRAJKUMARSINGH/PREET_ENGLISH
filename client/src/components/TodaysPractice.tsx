...
import { Sparkles, ArrowRight, Clock, Flame, Calendar } from "lucide-react";
...
export function TodaysPractice() {
  ...
  return (
    <div className="relative overflow-hidden w-full h-full bg-gradient-to-br from-primary/10 via-white to-primary/5 dark:from-primary/20 dark:via-secondary dark:to-primary/10 rounded-[2rem] border border-primary/20 p-8 group">
      {/* Decorative elements */}
