...
export function VideoScriptComponent(_a) {
    var topicTitle = _a.topicTitle, hindiInstruction = _a.hindiInstruction, englishModel = _a.englishModel, hindiBridge = _a.hindiBridge, confidenceBoost = _a.confidenceBoost;
    var _b = useState(false), isPlaying = _b[0], setIsPlaying = _b[1];
    var _c = useState(0), currentTime = _c[0], setCurrentTime = _c[1];
    var totalDuration = 45; // 45 seconds total
