...
const AchievementUnlock: React.FC<AchievementUnlockProps> = ({
  ...
  const rarityConfig = {
    common: {
      ...
      celebration: 'sparkles' as const,
    },
    rare: {
      gradient: 'from-blue-400 to-blue-600',
      glow: 'shadow-blue-500/50',
      border: 'border-blue-400',
      celebration: 'confetti' as const,
    },
    epic: {
      gradient: 'from-purple-400 to-purple-600',
      glow: 'shadow-purple-500/50',
      border: 'border-purple-400',
      celebration: 'fireworks' as const,
    },
    legendary: {
        ...
        >
          <div className="p-6 text-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <ModernBadge 
                variant="primary" 
                className={cn('text-xs uppercase tracking-wide', config.border)}
              >
                {achievement.rarity}
              </ModernBadge>
            </div>
