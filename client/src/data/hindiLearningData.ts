// Hindi-specific learning data for English learners
export interface HindiLearningContent {
  id: string;
...
export const commonGrammarMistakes = [
  {
...
export const culturalContextData = [
  {
...
export const businessEnglishForIndians = [
  {
...
export const dailyEnglishPhrases = [
  {
    category: 'Shopping',
    phrases: [
      {
...
// Export all data
export const hindiLearningData = {
