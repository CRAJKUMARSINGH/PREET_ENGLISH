...
export function useChatStream(conversationId) {
    ...
    var _d = useState(''), currentStream = _d[0], setCurrentStream = _d[1];
    return {
        messages: messages,
        ...
        sendMessage: function (message) { return __awaiter(_this, void 0, void 0, function () {
            var userMessage, res, data, aiMessage_1, error_1, errorMessage_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [7 /*endfinally*/];
                    case 6: return [2 /*return*/, "Response received"];
                }
            });
        }); }
    };
