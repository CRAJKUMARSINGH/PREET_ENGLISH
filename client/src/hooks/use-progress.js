        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch(api.progress.list.path, { credentials: "include" })];
                    case 1:
                        res = _a.sent();
                        if (!res.ok) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.warn('Progress fetch error, returning empty array:', error_1);
                        return [2 /*return*/, []];
...
export function useMarkComplete() {
    ...
    return useMutation({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var url, res;
            var lessonId = _b.lessonId, completed = _b.completed;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        url = buildUrl(api.progress.markComplete.path, { id: lessonId });
                    ...
                    case 1:
                        ...
                        if (!res.ok) {
                            ...
                            return [2 /*return*/, { id: Date.now(), userId: 1, lessonId: lessonId, completed: completed, completedAt: new Date().toISOString() }];
                        }
                        return [4 /*yield*/, res.json()];
