...
export const designUtils = {
  ...
  gradient: (from: string, to: string, direction: 'r' | 'l' | 'b' | 't' | 'br' | 'bl' | 'tr' | 'tl' = 'r') => 
  ...
  hoverElevate: (scale: number = 1.02) => 
    `hover:scale-${Math.round(scale * 100)} hover:shadow-lg transition-all duration-200`,
