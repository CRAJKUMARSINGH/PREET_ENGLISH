...
export default function Advanced() {
    var _a = useState('learning'), activeTab = _a[0], setActiveTab = _a[1];
    var tabs = [
    ...
    return (<div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
        {tabs.map(function (tab) {
            var Icon = tab.icon;
            return (<button key={tab.id} onClick={function () { return setActiveTab(tab.id); }} className={"flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all whitespace-nowrap ".concat(activeTab === tab.id
