...
export default function AdvancedHindiLearning() {
  ...
  return (
    <div className="advanced-hindi-learning container mx-auto px-4 py-8">
      {/* Header */}
      ...
      <div className="feature-overview grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <Card className="feature-card hover:shadow-lg transition-shadow cursor-pointer" onClick={() => setActiveTab('pronunciation')}>
        ...
        <Card className="feature-card hover:shadow-lg transition-shadow cursor-pointer" onClick={() => setActiveTab('conversation')}>
          <CardContent className="pt-6 text-center">
        ...
        <Card className="feature-card hover:shadow-lg transition-shadow cursor-pointer" onClick={() => setActiveTab('grammar')}>
          <CardContent className="pt-6 text-center">
        ...
        <Card className="feature-card hover:shadow-lg transition-shadow cursor-pointer" onClick={() => setActiveTab('personalization')}>
          <CardContent className="pt-6 text-center">
            ...
            <Card className="getting-started mt-8">
              ...
              <CardContent>
                ...
                <div className="flex gap-3">
                  <Button onClick={() => setActiveTab('personalization')} size="lg">
                    Start Assessment
                  </Button>
                  <Button onClick={() => setActiveTab('pronunciation')} variant="outline" size="lg">
                    Try AI Trainer
                  </Button>
                </div>
              </CardContent>
