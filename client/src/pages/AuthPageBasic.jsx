...
export default function AuthPageBasic() {
    ...
    return (<div style={{
            ...
            color: '#333'
                    ...
                    <input id="username" type="text" placeholder="Enter username (min 2 chars)" style={{
            width: '100%',
            padding: '12px',
            ...
            color: '#333'
                    ...
                    <input id="password" type="password" placeholder="Enter password (min 6 chars)" style={{
            width: '100%',
            padding: '12px',
            border: '2px solid #ddd',
            borderRadius: '8px',
            ...
            e.target.style.background = '#4CAF50';
                    ...
                    <button id="signup-btn" onClick={handleSignup} style={{
            flex: 1,
            padding: '15px',
            background: '#2196F3',
            color: 'white',
