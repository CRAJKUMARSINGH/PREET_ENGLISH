            ...
            <div className="max-w-5xl mx-auto space-y-12 pb-20">
                <header className="text-center space-y-4">
                    ...
                    <div className="relative max-w-xl mx-auto mt-8">
                        ...
                        <Input
                            type="text"
                            placeholder="Search help articles... मदद के लिए लेख खोजें..."
                            className="pl-12 h-14 rounded-2xl border-slate-200 shadow-lg focus:ring-primary text-lg"
                            value={searchTerm}
                            ...
                            <CardContent>
                                <form onSubmit={handleContactSubmit} className="space-y-4">
                                    <Input
                                        ...
                                        className="bg-white/10 border-white/20 placeholder:text-white/50 text-white rounded-xl h-12"
                                        required
                                    />
                                    <textarea
                                        placeholder="How can we help?"
                                        className="w-full bg-white/10 border-white/20 placeholder:text-white/50 text-white rounded-xl h-32 p-4 focus:outline-none focus:ring-2 focus:ring-white/30"
                                        required
                                    />
