...
import { MessageCircle, Theater, MessageSquare, Headphones, Users, Target, Sparkles } from "lucide-react";
...
export default function HindiConversation() {
    var _a, _b;
    var _c = useState("dialogue"), activeTab = _c[0], setActiveTab = _c[1];
    var features = [
        {
            id: "practice",
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-slate-900 dark:via-purple-900/10 dark:to-slate-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid grid-cols-2 md:grid-cols-4 gap-2 h-auto p-2 bg-white/50 dark:bg-slate-800/50 backdrop-blur">
            ...
            return (<TabsTrigger key={feature.id} value={feature.id} className="flex flex-col items-center gap-1 p-3">
