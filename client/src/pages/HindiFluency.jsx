...
import { Calendar, BookOpen, Mic, Target, Flame, TrendingUp } from 'lucide-react';
...
export default function HindiFluency() {
    ...
    return (<div className="hindi-fluency container mx-auto px-4 py-8">
      {/* Header */}
      ...
      <div className="feature-cards grid md:grid-cols-3 gap-4 mb-8">
        ...
        <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={function () { return setActiveTab('flashcards'); }}>
          <CardContent className="pt-6 text-center">
        ...
        <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={function () { return setActiveTab('confidence'); }}>
          <CardContent className="pt-6 text-center">
