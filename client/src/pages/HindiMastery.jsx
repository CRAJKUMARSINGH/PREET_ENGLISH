...
import { Languages, Mail, Briefcase, Award, Target } from 'lucide-react';
...
export default function HindiMastery() {
    ...
    return (<div className="hindi-mastery container mx-auto px-4 py-8">
      {/* Header */}
      ...
      <div className="feature-cards grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={function () { return setActiveTab('translation'); }}>
        ...
        <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={function () { return setActiveTab('writing'); }}>
          <CardContent className="pt-6 text-center">
        ...
        <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={function () { return setActiveTab('interview'); }}>
          <CardContent className="pt-6 text-center">
        ...
        <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={function () { return setActiveTab('certification'); }}>
          <CardContent className="pt-6 text-center">
