...
export default function HindiVocabulary() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-slate-900 dark:via-purple-900/10 dark:to-slate-900">
            ...
            {features.map((feature) => {
              ...
              return (
                <TabsTrigger
                  key={feature.id}
                  value={feature.id}
                  className={`flex flex-col items-center gap-1 p-3 data-[state=active]:bg-${feature.color}-100 dark:data-[state=active]:bg-${feature.color}-900/30`}
                >
