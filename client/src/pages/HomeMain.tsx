          ...
          <div className="flex-1 space-y-4 text-center md:text-left z-10">
            ...
            <div className="flex items-center justify-center md:justify-start gap-4 mt-6">
              ...
              <div className="hidden md:flex items-center -space-x-3">
                {[1, 2, 3].map(i => (
                  <div key={i} className="w-8 h-8 rounded-full bg-slate-200 dark:bg-slate-700 border-2 border-background" />
                ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="flex bg-secondary/30 p-1 rounded-2xl w-fit">
            <button
              ...
              className={`px-6 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 ${activeTab === 'lessons' ? 'bg-primary text-primary-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'}`}
            >
              Lessons
            </button>
            <button
              onClick={() => setActiveTab('scenarios')}
              className={`px-6 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 ${activeTab === 'scenarios' ? 'bg-primary text-primary-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'}`}
            >
              Roleplay
            </button>
          </div>
          ...
          {activeTab === 'lessons' ? (
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {isLoading ? (
                  <div className="md:col-span-2 py-20 flex justify-center">
        ...
        <div className="space-y-8">
          ...
          {leaderboardEntries.length > 0 && (
            <LeaderboardCard entries={leaderboardEntries.slice(0, 5)} currentUserRank={currentUserRank} />
          )}
      ...
      {showHolographicDashboard && (
        <section className="mt-12">
          <HolographicDashboard
            defaultTab="overview"
            onFeatureActivated={(feature: any) => {
