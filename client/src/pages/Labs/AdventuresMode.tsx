                        ...
                        {adventures.map((adventure) => (
                            <Card
                                ...
                                className={cn(
                                    ...
                                    !adventure.unlocked && "opacity-60"
                                )}
                                onClick={() => adventure.unlocked && setSelectedAdventure(adventure)}
                            >
                                <div className={cn(
                                ...
                                <CardContent className="p-6 relative">
                                    <div className="flex items-start gap-4">
                                        <div className={cn(
                                            "w-16 h-16 rounded-2xl flex items-center justify-center text-white bg-gradient-to-br shadow-lg",
                                            adventure.color
                                        )}>
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="overflow-hidden">
                            ...
                            <CardContent className="p-6 space-y-6">
                                        ...
                                        <Button
                                            ...
                                            className={cn(
                                                ...
                                                showFeedback && selectedChoice === index && (
                                                    choice.correct ? "bg-green-500 hover:bg-green-500" : "bg-red-500 hover:bg-red-500"
                                                )
                                            )}
                                ...
                                {showFeedback && selectedChoice !== null && (
                                    <div className={cn(
                                        ...
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            {currentScene.choices[selectedChoice].correct && (
                                                <span className="text-green-600 text-sm">+{currentScene.xp} XP</span>
                                            )}
                                        </div>
                                ...
                                {/* Next Button */}
                                {showFeedback && (
                                    <Button onClick={handleNextScene} className="w-full">
