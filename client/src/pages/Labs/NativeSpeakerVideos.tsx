...
export default function NativeSpeakerVideos() {
    const [selectedVideo, setSelectedVideo] = useState(nativeSpeakerVideos[0]);
    ...
    const progress = (completedPhrases.size / selectedVideo.phrases.length) * 100;
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                {/* Current Phrase */}
                                <div className="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border-2 border-blue-200 dark:border-blue-800 cursor-pointer group" onClick={() => playAudio(selectedVideo.phrases[currentPhraseIndex].english)}>
                                    ...
                                    {showHindi && (
                                        <p className="text-xl text-center text-blue-600 dark:text-blue-400">
                                    ...
                                    <div className="flex justify-center gap-3 mt-4">
                                        ...
                                        <Button variant="outline" size="icon" onClick={(e) => { e.stopPropagation(); /* Implement mic logic later if needed */ }}>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    {currentPhraseIndex < selectedVideo.phrases.length - 1 ? (
                                        <Button onClick={handlePhraseComplete}>
                                            Next
                                            <ChevronRight className="h-4 w-4 ml-1" />
                                        </Button>
                                    ) : (
                                        <Button className="bg-green-500 hover:bg-green-600" onClick={handlePhraseComplete}>
