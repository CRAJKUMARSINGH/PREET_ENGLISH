...
export default function PodcastFeed() {
    ...
    const progress = (currentTime / currentEpisode.durationSeconds) * 100;
                            ...
                            {podcastEpisodes.map((episode) => (
                                <Card
                                    ...
                                    className={cn(
                                        ...
                                        currentEpisode.id === episode.id && "ring-2 ring-green-500 border-green-500"
                                    )}
                                    onClick={() => {
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 mb-1">
                                                    ...
                                                    {episode.isNew && (
                                                        <Badge className="bg-green-500 shrink-0">NEW</Badge>
                                                    )}
                                                </div>
                                            ...
                                            <Button
                                                size="icon"
                                                variant={currentEpisode.id === episode.id && isPlaying ? "default" : "outline"}
                                                className="shrink-0"
                                                onClick={(e) => {
                                                    e.stopPropagation();
                        ...
                        <Card className="sticky top-4">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="flex items-center justify-center gap-4">
                                    ...
                                    <Button variant="ghost" size="icon" onClick={() => setCurrentTime(Math.min(currentEpisode.durationSeconds, currentTime + 15))}>
