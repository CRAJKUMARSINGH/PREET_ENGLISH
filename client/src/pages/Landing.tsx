            ...
            <section className="relative pt-40 pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
                <div className="flex-1 text-center lg:text-left relative z-10">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-black uppercase tracking-[0.2em] mb-8 shadow-sm"
                    >
                    ...
                    <motion.h1
                        ...
                        className="text-6xl sm:text-7xl lg:text-8xl font-black leading-[0.95] text-foreground mb-8 tracking-tighter"
                    >
                        Speak English <br />
                    ...
                    <motion.p
                        ...
                        className="text-xl text-muted-foreground/80 mb-10 max-w-2xl mx-auto lg:mx-0 font-medium leading-relaxed"
                    >
                    ...
                    >
                        ...
                        <div className="flex -space-x-3 items-center justify-center">
                            {[1, 2, 3, 4].map((i) => (
                                <div key={i} className={`w-12 h-12 rounded-full border-4 border-background bg-secondary flex items-center justify-center overflow-hidden shadow-xl`}>
                    ...
                    <div className="grid lg:grid-cols-3 gap-10">
                        {[
                            ...
                            <motion.div
                                whileHover={{ y: -10 }}
                                key={i}
                                className={`bg-white/[0.03] p-10 rounded-[2.5rem] border border-white/5 hover:border-primary/20 transition-all group overflow-hidden relative shadow-2xl`}
                            >
