                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <Link key={story.id} href={`/story/${story.id}`}>
                                <Card className="group cursor-pointer overflow-hidden border-none shadow-sm hover:shadow-xl transition-all duration-300 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
                                    <div className="aspect-video relative overflow-hidden">
                                        <img
                                            src={story.imageUrl || "https://images.unsplash.com/photo-1544947950-fa07a98d237f?auto=format&fit=crop&q=80&w=800"}
                                            alt={story.title}
                        ...
                        {(!stories || stories.length === 0) && (
                            <div className="col-span-full py-20 text-center space-y-4 bg-slate-50 rounded-3xl border-2 border-dashed">
