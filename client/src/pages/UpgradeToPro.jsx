...
import { Check, Zap, Crown, Shield, Headphones, Award } from "lucide-react";
...
export default function UpgradeToPro() {
    ...
    return (<Layout>
            <SEO title="Upgrade to Pro" description="Unlock the full potential of Preet English with Pro features. Unlimited AI tutoring, official certificates, and more."/>
                    ...
                    <Card className="rounded-3xl border-4 border-primary shadow-2xl relative overflow-hidden transform hover:scale-[1.02] transition-all">
                        ...
                        <CardContent className="space-y-6 p-8">
                            ...
                            <ul className="space-y-4">
                                {features.map(function (f, i) { return (<li key={i} className="flex items-start gap-3">
                            ...
                            <Button className="w-full rounded-2xl h-14 text-lg font-bold shadow-lg shadow-primary/30" onClick={function () { return trackEvent("pro_upgrade_click", { tier: "monthly" }); }}>
                                Go Pro Now ✨
                            </Button>
