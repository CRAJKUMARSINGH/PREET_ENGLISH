...
export class QualityRubric {
  private readonly WEIGHTS: QualityCriteria = {
    accuracy: 0.25,           // 25% - Grade 9 requires absolute precision
    relevance: 0.10,          // 10%
    clarity: 0.15,            // 15%
    completeness: 0.15,       // 15% - No missing fields allowed
    culturalSensitivity: 0.20, // 20% - Critical for Hindi speakers (increased)
    pedagogy: 0.10,           // 10%
    diversity: 0.05,          // 5%
    coherence: 0.05           // 5%
  };
