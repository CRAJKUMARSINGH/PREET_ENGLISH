    ...
    for (const listening of LISTENINGS) {
        try {
            await db.insert(listenings).values({
                ...
                titleHindi: listening.titleHindi,
                description: listening.description,
                descriptionHindi: listening.descriptionHindi,
                difficulty: listening.difficulty,
                category: listening.category,
                audioText: listening.audioText,
                audioTextHindi: listening.audioTextHindi,
            ...
            if (err.message.includes('UNIQUE')) {
                console.log(`  ⏭️ Skipped: ${listening.title}`);
            } else {
